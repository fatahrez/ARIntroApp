...
class ThresholdPanGestureRecognizer: UIPanGestureRecognizer {
    ...
    /// Inidcates whether the currently active gesture has exceeded the threshold.
    private(set) var isThresholdExceeded = false
    
    /// The initial touch loaction when this gesture started.
    ...
    func offsetLoaction(in view: UIView?) -> CGPoint {
